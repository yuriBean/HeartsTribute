                    ...
                    <div className={`body-margin`}>
                        ...
                        <div className='py-2'>
                            <div className="tab flex justify-around w-full gap-2">
                                ...
                                <button onClick={() => navigate(`/profile/${profile_id}/tribute`)} className={`${location.pathname.includes("tribute") ? 'bg-black text-white' : 'text-black bg-gray-200'} rounded text-[0.6rem] md:text-base lg:text-lg 2xl:text-xl tracking-widest py-2 lg:py-4 w-1/4`} >TRIBUTE</button>
